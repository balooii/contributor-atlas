...
Colors for each category within the same group have the same hue. The distinction between categories within a group - like feature implementation vs. bugfix - is often
